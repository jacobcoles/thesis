...
# Input paths
parser.add_argument('--model', type=str, default='log_relation_transformer_bu/model-best.pth',#'models/log_relation_transformer_bu_rl/model-best.pth'
                help='path to model to evaluate')
parser.add_argument('--cnn_model', type=str,  default='resnet101',
                help='resnet101, resnet152')
parser.add_argument('--infos_path', type=str, default='log_relation_transformer_bu/infos_relation_transformer_bu-best.pkl',#'models/log_relation_transformer_bu_rl/infos_relation_transformer_bu-best.pkl'
...
parser.add_argument('--image_folder', type=str, default='../SentencesNYUv2_toolbox/data/images',
...
parser.add_argument('--input_rel_box_dir',type=str, default='data/cocobu_box_relative',
