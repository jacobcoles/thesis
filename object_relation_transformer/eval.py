...
e.g.: python eval.py \
        ...
        --language_eval 1
#my version:
python eval.py --dump_images 1 --num_images 10 --model models/log_relation_transformer_bu_rl/model-best.pth --infos_path models/log_relation_transformer_bu_rl/infos_relation_transformer_bu-best.pkl --image_root ../SentencesNYUv2_toolbox/data/images --input_json data/cocotalk.json --input_label_h5 data/cocotalk_label.h5  --input_fc_dir data/cocobu_fc --input_att_dir data/cocobu_att --input_box_dir data/cocobu_box --input_rel_box_dir data/cocobu_box_relative
