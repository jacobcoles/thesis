...
"""
# images at'thesis/SentencesNYUv2_toolbox/data/images'
...
def main(params):
    ...
    path_boi = params['images_root']
    
    imgs = [str(int(str(file).strip('.jpg'))) for file in os.listdir(path_boi) if '.jpg' in str(file)]
    ...
    for i,img in enumerate(imgs):
        # load the image self.features_path + '/' + 
        #I = skimage.io.imread(os.path.join(params['images_root'], (str(img).zfill(12) + '.npy') ))
        I = skimage.io.imread(os.path.join(params['images_root'], (str(img).zfill(4) + '.jpg') ))
...
if __name__ == "__main__":
    ...
    # options
    parser.add_argument('--images_root', default='../SentencesNYUv2_toolbox/data/images', help='root location in which images are stored, to be prepended to file_path in input json')
